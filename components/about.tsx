      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto font-light leading-relaxed">
            Клубный дом «Визионер» — воплощение современной архитектуры, приватности и статуса в сердце Петроградского района Санкт-Петербурга. Каждый элемент комплекса отражает эстетику будущего: выразительные фасады из натурального камня, приватный закрытый двор с ландшафтным озеленением, тематические зоны отдыха и детская площадка европейского уровня.  На территории действует видеонаблюдение и круглосуточная охрана. Лобби и входные зоны оформлены по авторскому дизайн-проекту с использованием натурального камня и декоративных элементов, поддерживающих атмосферу уюта и статуса.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center group">
            ...
            <p className="text-gray-600 font-light"> Преемственность
              эпох - плавные изгибы, скруглённые углы, полуциркульная арка входа</p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className="text-gray-600 font-light">
              Эксклюзивные форматы: квартиры с увеличенной жилой площадью и высотой потолков
            </p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className="text-gray-600 font-light">Подземный паркинг на 153 машино-места с лифтом и кладовыми и 22 гостевых места</p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className="text-gray-600 font-light">
              Масштабное озеленение — высажено более 4500 растений, из которых 39 крупномерных деревьев
            </p>
          </div>
        </div>
      </div>

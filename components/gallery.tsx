...
const images = [
  {
    src: "/images/gallery/img-0992.webp",
    alt: "Элегантный фасад клубного дома «Визионер» с арочным входом и декоративными элементами из светлого кирпича, современная архитектура с премиальной отделкой",
  },
  {
    src: "/images/gallery/img-0990.webp",
    alt: "Современный жилой комплекс «Визионер» из светлого кирпича с террасами и панорамными окнами, элегантная архитектура в городской среде",
  },
  {
    src: "/images/gallery/img-1003.webp",
    alt: "Вечерний вид на клубный дом «Визионер» с эффектной архитектурной подсветкой, современные фасады и коммерческие помещения на первом этаже",
  },
  {
    src: "/images/gallery/img-0993.webp",
    alt: "Благоустроенная детская площадка во дворе жилого комплекса «Визионер» с современными качелями и зелеными насаждениями",
  },
  {
    src: "/images/gallery/img-0979.webp",
    alt: "Общий вид жилого комплекса «Визионер» с зеленой зоной и современной городской инфраструктурой, светлые фасады из кирпича",
  },
  {
    src: "/images/gallery/img-0994.webp",
    alt: "Уличный вид на клубный дом «Визионер» в вечернее время с теплым освещением витрин и современной архитектурой",
  },
]
...
export default function Gallery() {
  ...
  const imageGalleryJsonLd = {
    ...
    "@type": "ImageGallery",
    name: "Галерея ЖК Визионер",
    description: "Фотографии жилого комплекса «Визионер» в Санкт-Петербурге",
    about: {

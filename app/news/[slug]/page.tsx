...
const articles: Article[] = [
  {
    id: "5",
    slug: "vizioner-dom-s-pinakotekoy",
    title: "Клубный дом «Визионер»: дом с картинной галереей на Петроградской стороне",
    excerpt:
      "«Визионер» — камерный клубный дом в сердце Петроградской стороны, где архитектура эклектики соединена с живым искусством: в лобби создана полноценная пинакотека с работами современных художников.",
    content: `
      <script type="application/ld+json">
      {
        "@context": "https://schema.org",
        "@type": "BlogPosting",
        "@id": "https://art-visioner.ru/news/vizioner-dom-s-pinakotekoy#post",
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": "https://art-visioner.ru/news/vizioner-dom-s-pinakotekoy"
        },
        "headline": "Клубный дом «Визионер»: дом с картинной галереей на Петроградской стороне",
        "alternativeHeadline": "Пинакотека, эклектика и приватные пространства: арт‑концепция «Визионера»",
        "description": "«Визионер» — камерный клубный дом, где архитектура эклектики объединена с живым искусством: в лобби создана пинакотека с работами современных художников, а общественные пространства — от витражной анфилады до приватного патио — спроектированы как продолжение художественной экспозиции и комфортной городской жизни.",
        "articleSection": [
        ...
        "author": {
          "@type": "Organization",
          "@id": "https://art-visioner.ru/#org",
          "name": "Редакция блога «Визионер»"
        },
        "publisher": {
          "@type": "Organization",
          "@id": "https://art-visioner.ru/#org",
          "name": "Визионер — официальный сайт",
          "logo": {
            "@type": "ImageObject",
            "url": "https://art-visioner.ru/images/logo.png",
            "width": 512,
            "height": 512
          }
        },
        "image": [
          "https://art-visioner.ru/images/art-gallery-interior.png",
          "https://art-visioner.ru/images/building-facade.webp",
          "https://art-visioner.ru/images/courtyard-1.jpeg"
        ],
        "about": [
          {
            "@type": "Place",
        ...
        "articleBody": "«Визионер» — дом, который перешагивает границы классического девелопмента, превращая общее пространство в продуманный арт‑маршрут. Лобби встречает пинакотекой — полноценной экспозицией современного искусства. Витражная анфилада объединяет корпуса и продолжает галерейный сценарий, а эклектичные фасады из натурального камня с рустами, карнизами и латунными деталями задают архитектурный тон. Входная площадь, зелёный двор‑патио без машин, вечерняя подсветка и камерные зоны отдыха формируют частный городской «салон». Такой формат выбирают те, для кого культура и эстетика — часть повседневной жизни, а также инвесторы, ориентированные на редкое предложение клубных домов в историческом центре."
      }
      </script>

      <p><strong>«Визионер» — камерный клубный дом в сердце Петроградской стороны, где архитектура эклектики соединена с живым искусством:</strong> в лобби создана полноценная пинакотека с работами современных художников, а общественные пространства спроектированы как продолжение художественной экспозиции и комфортной городской жизни.</p>
      ...
      <ul>
        <li>Для ценителей искусства и впечатлений: здесь искусство — часть повседневности, а не редкое событие.</li>
      ...
      <h3>Ключевые преимущества «Визионера»</h3>
      <ul>
  ...
  {
    id: "4",
    slug: "zastroishchik-razreshenie-vizioner",
    title: "Застройщик получил разрешение на строительство клубного дома «Визионер» на Петроградской стороне",
    excerpt:
      "Госстройнадзор Санкт‑Петербурга выдал разрешение на строительство клубного дома «Визионер» по адресу ул. Чапыгина, 4 — камерного проекта премиум‑класса на 69 квартир с авторской эклектичной архитектурой, лобби‑пинакотекой, приватным двор‑патио и двухуровневым паркингом.",
    content: `
      <script type="application/ld+json">
      {
        "@context": "https://schema.org",
        "@type": "BlogPosting",
        "@id": "https://art-visioner.ru/news/zastroishchik-razreshenie-vizioner#post",
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": "https://art-visioner.ru/news/zastroishchik-razreshenie-vizioner"
        },
        "headline": "Застройщик получил разрешение на строительство клубного дома «Визионер» на Петроградской стороне",
        "alternativeHeadline": "Разрешение на строительство: старт флагманского проекта «Визионер» на ул. Чапыгина, 4",
        "description": "Госстройнадзор Санкт‑Петербурга выдал разрешение на строительство клубного дома «Визионер»: 69 камерных квартир 43–222 м², авторская эклектичная архитектура, лобби‑пинакотека, приватный двор‑патио и двухуровневый паркинг на Петроградской стороне.",
        "articleSection": [
      ...
      <p><strong>Госстройнадзор Санкт‑Петербурга выдал разрешение на строительство клубного дома «Визионер» по адресу ул. Чапыгина, 4</strong> — камерного проекта премиум‑класса на 69 квартир с авторской эклектичной архитектурой, лобби‑пинакотекой, приватным двор‑патио и двухуровневым паркингом.</p>
      ...
      <ul>
        ...
        <li><strong>Старт нового флагманского проекта:</strong> застройщик закрепляет экспертизу в премиальном сегменте и архитектуре «для ценителей искусства».</li>
